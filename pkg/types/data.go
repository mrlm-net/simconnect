...
const (
	SIMCONNECT_CREATE_CLIENT_DATA_FLAG_DEFAULT   SIMCONNECT_CREATE_CLIENT_DATA_FLAG = 0
	SIMCONNECT_CREATE_CLIENT_DATA_FLAG_READ_ONLY SIMCONNECT_CREATE_CLIENT_DATA_FLAG = 1
)
